...
Compression is set to _Fast_ (`-mx3` 7zip parameter) by default, but it can be overridden by the `compression-ratio` field at the task level. It should also compress files open for writing (`-ssw` 7zip parameter).
